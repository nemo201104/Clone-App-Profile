...
public final class UpdateMetadata {
    ...
    public static JSONObject evaluate(JSONObject data,int current) throws Exception {
        ...
        String release="https://github.com/nemoforge/Clone-App-Profile/releases/";
        Failure.require(data.getString("zipUrl").equals(release+"download/"+version+"/Clone-App-Profile-"+version+".zip")
            && data.getString("changelog").equals("https://raw.githubusercontent.com/nemoforge/Clone-App-Profile/"+version+"/CHANGELOG.md"),"INVALID_UPDATE_METADATA","Unexpected release URL");
